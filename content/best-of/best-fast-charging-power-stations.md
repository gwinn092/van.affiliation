...
## How we rank: recovery-first (not spec-sheet worship)

We rank by **how quickly you can realistically get back to stable**:
1) **Wall / shore recovery** (fastest, most reliable when available)
2) **Drive recovery** (when your routine includes movement)
...
## A quick sourcing note (so you can trust this page)

Portable power brands love big charging claims. We separate sources:

- **Manufacturer claim:** what the brand states on its product page.
- **Third-party test:** a reviewer measured it in real use.

You'll see both called out below.
...
## How to choose between them (fast, practical)

### If you want the shortest "coffee shop refill" window
Start with **Anker SOLIX C1000 Gen 2**.

### If you want fast recovery in a smaller 700-800Wh class
Start with **EcoFlow RIVER 2 Pro** or **BLUETTI AC70**.

### If you want approx. 1kWh with a "fast mode" option for emergencies
Start with **Jackery Explorer 1000 v2**.

### If your life is mostly parked days with occasional shore access
Fast AC recovery matters most. Use:
- **[Shore Power Recovery Routine](/shore-power-recovery-routine/)**
- **[Recovery Window Priority Map](/recovery-window-priority-map/)**
...
## Safety + sanity notes (fast charging without spiraling)

- Fast charging is a **tool**, not a lifestyle.
- Many brands include "standard/health" modes vs "fast/emergency" modes (often app-controlled). Treat fast mode as **recovery**, especially if you're already stressed.
- If arguments start when battery is low, use the script, not the debate.
...
Next step: use the chooser to decide your best recovery move today: **[Recovery Window Priority Map](/recovery-window-priority-map/)**.
